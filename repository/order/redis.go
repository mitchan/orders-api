...
import (
	...
	"github.com/mitchan/orders-api/model"
...
func (r *RedisRepo) Insert(ctx context.Context, order model.Order) error {
	...
	res := transaction.SetNX(ctx, key, string(data), 0)
...
func (r *RedisRepo) FindByID(ctx context.Context, id uint64) (model.Order, error) {
	...
	if err != nil {
		return model.Order{}, fmt.Errorf("failed to decode order json: %w")
	}
...
func (r *RedisRepo) DeleteById(ctx context.Context, id uint64) error {
	...
	if err := transaction.SRem(ctx, "orders", key); err != nil {
		transaction.Discard()
